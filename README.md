...
- 🗜️ **Package Compression** - Creates optimized `.ccp` package files
- 📦 **Automatic Indexing** - Generates package indexes with metadata and checksums
- ✨ **Lua Minification** - Optional source code minification to reduce package size
- 🔧 **Repository Management** - Build and maintain CCPM repositories with ease
- 🐳 **Container Support** - Available as a Docker/OCI container image
- 🔄 **Version Control** - Optional package version history maintenance
- ✅ **Validation** - Validates package manifests and SPDX license identifiers
...
├── packages/              # Package source directory
│   └── your-package/
│       ├── manifest.json  # Package metadata
│       └── source/        # Package files
└── pool/                  # Generated by ccpmbuild
    ├── index.json
    ├── manifest.json
    └── *.ccp
```
